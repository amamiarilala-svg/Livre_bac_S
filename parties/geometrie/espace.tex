...
\begin{enumerate}
	\item Vérifier que le plan $(ABC)$ a pour équation $3x - 2y + 3z - 8 = 0$.
	...
	\begin{enumerate}
		...
		déduire la distance de $A$ à $(D)$.
	\end{enumerate}
	\item Soit $(R) : x - y + z = 1$. Déterminer les coordonnées du point $I$,
	intersection des trois plans $(ABC)$, $(Q)$ et $(R)$.
\end{enumerate}
...
\begin{enumerate}
	...
	vecteur directeur $\vec u(1;2;-1)$ passant par $D$.
	\item Montrer que $(\Delta)$ est strictement parallèle au plan $(ABC)$.
\end{enumerate}
...
\begin{enumerate}
	...
	$A$, de vecteur normal $\vec n(-3;-2;-6)$.
	\item Déterminer la distance qui sépare $(P)$ et $(Q)$.
...
\begin{enumerate}
	...
	centre $\Omega$ et le rayon $R$ de $(S)$.
...
\begin{enumerate}
	...
	$A$ de vecteur directeur $\vec u$.
	\item Soit $(D') : (x;y;z) = (4t + 1\,;\,5t - 8\,;\,-2t + 6)$, $t \in \R$.
	\begin{enumerate}
		\item Montrer que $(D)$ et $(D')$ sont orthogonales.
