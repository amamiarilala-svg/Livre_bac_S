...
\begin{propriete}
	\textbf{Caractérisation vectorielle}\par
...
\begin{propriete}
	\textbf{Associativité du barycentre}\par
...
\begin{propriete}
	\textbf{Linéarité — relation de Chasles généralisée}\par
...
\begin{propriete}
	\textbf{Coordonnées du barycentre}\par
...
\begin{propriete}
	\textbf{Centres remarquables comme barycentres}\par
	Soit $ABC$ un triangle.
	\begin{enumerate}
		\item Le \textbf{centre de gravité} $G$ est le barycentre de
		$\{(A,1)\,;\,(B,1)\,;\,(C,1)\}$.
		Il vérifie $\vect{GA} + \vect{GB} + \vect{GC} = \vect{0}$.
...
\begin{propriete}
	\textbf{Nature des lignes de niveau}\par
