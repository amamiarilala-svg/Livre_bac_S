...
\begin{enumerate}
	...
	$\displaystyle\lim_{x\to+\infty}f(x)$ ; préciser les branches infinies. \hfill \mbox{(1~pt)}
	\item Montrer que $f'(x)=-x\,\e^{-x}$ et dresser le tableau de
	variations ; préciser le maximum. \hfill \mbox{(0,75~pt)}
	\item Montrer que $f''(x)=(x-1)\,\e^{-x}$, étudier la convexité et
	déterminer le point d'inflexion $I$ de $\mathcal C$. \hfill \mbox{(0,75~pt)}
	\item Déterminer l'équation de la tangente $T$ à $\mathcal C$ au point
	d'abscisse $0$. \hfill \mbox{(0,5~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	de $0$. \hfill \mbox{(0,5~pt)}
	\item Résoudre $f(x)=0$ et déterminer les coordonnées des points
	d'intersection de $\mathcal C$ avec les axes. \hfill \mbox{(0,5~pt)}
...
\begin{enumerate}
	...
	asymptote. \hfill \mbox{(0,75~pt)}
	\item Montrer que la droite $\Delta:\;y=x-2$ est asymptote à $\mathcal C$
	en $+\infty$. \hfill \mbox{(0,5~pt)}
	\item Étudier la position de $\mathcal C$ par rapport à $\Delta$. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	$g(x)=x^{2}+1-\ln x$. Étudier $g$ et en déduire le signe de $f'$. \hfill \mbox{(1~pt)}
	\item Dresser le tableau de variations de $f$. \hfill \mbox{(0,5~pt)}
	\item Montrer que l'équation $f(x)=0$ admet une unique solution
	$\alpha$, et que $1<\alpha<2$. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	et la nature de la branche infinie. \hfill \mbox{(0,75~pt)}
	\item Montrer que $f'(x)=\dfrac{2x}{1+x^{2}}$ ; dresser le tableau de
	variations. \hfill \mbox{(0,5~pt)}
	\item Montrer que $f''(x)=\dfrac{2\bigl(1-x^{2}\bigr)}{\bigl(1+x^{2}\bigr)^{2}}$
	et que $\mathcal C$ a deux points d'inflexion, d'abscisses $\pm 1$. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	\setcounter{enumi}{3}
	\item Identifier $\mathcal C_1$ (courbe toujours positive, sans maximum). \hfill \mbox{(0,5~pt)}
	...
	$\mathcal C_2$ a ses extremums. \hfill \mbox{(1~pt)}
	\item Justifier que la courbe de $f'$ est impaire et celle de $f''$ paire. \hfill \mbox{(0,5~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	rapport à $\Delta$ selon le signe de $m$. \hfill \mbox{(1~pt)}
	\item Calculer $f_m'(x)$ et $f_m''(x)$. Étudier, selon $m$, l'existence
	d'un extremum et sa nature. \hfill \mbox{(1~pt)}
	\item Pour $m>0$, montrer que le minimum de $f_m$ a pour coordonnées
	$\bigl(\ln m\,;\,\ln m+1\bigr)$ ; en déduire que ce minimum décrit la
	droite $y=x+1$ quand $m$ décrit $]0\,;+\infty[$. \hfill \mbox{(0,75~pt)}
\end{enumerate}

\textbf{Partie B — Le cas $m=1$}
\begin{enumerate}
	\setcounter{enumi}{3}
	\item Étudier $f_1(x)=x+\e^{-x}$ : variations, convexité. \hfill \mbox{(0,75~pt)}
	\item Montrer que $\mathcal C_1$ est au-dessus de $\Delta$ et que $f_1$
	admet un minimum égal à $1$ en $x=0$. \hfill \mbox{(0,5~pt)}
	\item Tracer $\Delta$ et $\mathcal C_1$. \hfill \mbox{(0,5~pt)}
\end{enumerate}
