...
\begin{enumerate}
	\item Montrer que $f$ est continue en $0$. \hfill \mbox{(0,75~pt)}
	\item Montrer que la droite $y=0$ est asymptote à $\mathcal C$ en $-\infty$. \hfill \mbox{(0,5~pt)}
	\item Montrer que la droite $y=1$ est asymptote à $\mathcal C$ en $+\infty$. \hfill \mbox{(0,5~pt)}
	\item Montrer que, pour tout $x>0$, $f(x)>1$ ; préciser la position de
	$\mathcal C$ par rapport à son asymptote en $+\infty$. \hfill \mbox{(0,5~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	$\displaystyle\lim_{x\to 0^-}f(x)$. \hfill \mbox{(0,5~pt)}
	\item En déduire que l'équation $f(x)=\dfrac{1}{2}$ admet une unique solution
	$\alpha$ dans $]-\infty\,;0[$. \hfill \mbox{(0,75~pt)}
	\item Montrer que $-2<\alpha<-1$. \hfill \mbox{(0,5~pt)}
	\item Montrer que $\alpha$ vérifie $\e^{\alpha}=1+\dfrac{\alpha}{2}$. \hfill \mbox{(0,5~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	strictement croissante sur $\R$. \hfill \mbox{(0,5~pt)}
	\item Déterminer $\displaystyle\lim_{x\to-\infty}g_n(x)$ et
	$\displaystyle\lim_{x\to+\infty}g_n(x)$. \hfill \mbox{(0,5~pt)}
	\item En déduire que $(E_n)$ admet une unique solution $\alpha_n$ dans $\R$. \hfill \mbox{(0,5~pt)}
	\item Montrer que $0<\alpha_n<\ln n$ pour $n\geq 2$. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	strictement croissante. \hfill \mbox{(0,75~pt)}
	\item Montrer que $\displaystyle\lim_{n\to+\infty}\alpha_n=+\infty$. \hfill \mbox{(0,5~pt)}
	\item À partir de $\e^{\alpha_n}=n-\alpha_n$, montrer que
	$\alpha_n=\ln n+\ln\!\Bigl(1-\dfrac{\alpha_n}{n}\Bigr)$, puis que
	$\displaystyle\lim_{n\to+\infty}\bigl(\alpha_n-\ln n\bigr)=0$. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	\item Déterminer $\displaystyle\lim_{x\to-\infty}f(x)$ ; en déduire une
	asymptote. \hfill \mbox{(0,5~pt)}
	\item Déterminer $\displaystyle\lim_{x\to+\infty}f(x)$. \hfill \mbox{(0,25~pt)}
	\item On admet que $f$ est continue et strictement croissante sur
	$[0\,;+\infty[$. Montrer que l'équation $f(x)=0$ admet une unique solution
	$\alpha$ dans $[0\,;+\infty[$, et qu'elle n'en admet aucune sur
	$]-\infty\,;0]$. \hfill \mbox{(1~pt)}
	\item Montrer que $0{,}5<\alpha<0{,}6$. \hfill \mbox{(0,5~pt)}
	\item Montrer que $\alpha=\e^{-\alpha}$ et que $\alpha=-\ln\alpha$. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	Calculer $u_1$ et $u_2$ (valeurs approchées à $10^{-3}$). \hfill \mbox{(0,5~pt)}
	\item En admettant que $(u_n)$ converge, déterminer sa limite. \hfill \mbox{(0,5~pt)}
\end{enumerate}
...
\begin{enumerate}
	\item Déterminer $\displaystyle\lim_{x\to-\infty}f(x)$ et
	$\displaystyle\lim_{x\to+\infty}f(x)$. En déduire deux asymptotes. \hfill \mbox{(0,75~pt)}
	\item Déterminer $\displaystyle\lim_{x\to 0^-}f(x)$ et
	$\displaystyle\lim_{x\to 0^+}f(x)$. En déduire une asymptote et justifier
	que $f$ \emph{n'est pas} prolongeable par continuité en $0$. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	$\mathcal C$ par rapport à la droite $y=1$. \hfill \mbox{(0,5~pt)}
	\item Montrer que, pour tout $x\neq 0$, $f(x)+f(-x)=1$. Interpréter
	géométriquement. \hfill \mbox{(0,5~pt)}
	\item Montrer que l'équation $f(x)=-1$ admet une unique solution que l'on
	déterminera exactement. \hfill \mbox{(0,75~pt)}
\end{enumerate}
