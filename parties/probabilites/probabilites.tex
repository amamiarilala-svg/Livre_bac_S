...
\begin{enumerate}
	...
	équiprobables. \hfill \mbox{(0,5~pt)}
	\item Calculer le nombre de tirages tricolores (une boule de chaque
	couleur). \hfill \mbox{(0,5~pt)}
	\item Calculer le nombre de tirages unicolores. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	$\Prob(U)$ où $U$ : « le tirage est unicolore ». \hfill \mbox{(0,75~pt)}
	\item Calculer $\Prob(R)$ où $R$ : « le tirage contient au moins une
	rouge » (on pourra passer au contraire). \hfill \mbox{(0,75~pt)}
	\item On note $X$ le nombre de boules blanches obtenues. Déterminer les
	valeurs prises par $X$ et la probabilité $\Prob(X=2)$. \hfill \mbox{(1~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	$\Prob(M)$, $M$ : « obtenir un multiple de $3$ ». \hfill \mbox{(0,75~pt)}
...
\textbf{Partie A}
\begin{enumerate}
	\item Combien y a-t-il de codes valides ? \hfill \mbox{(0,5~pt)}
	\item Combien de codes n'utilisent aucune lettre ? \hfill \mbox{(0,5~pt)}
	\item Combien de codes utilisent au moins une lettre ? \hfill \mbox{(0,5~pt)}
\end{enumerate}
...
\begin{enumerate}
	\item Déterminer le nombre de comités possibles. \hfill \mbox{(0,5~pt)}
	\item Calculer la probabilité que le comité soit composé de $2$ femmes et
	$2$ hommes. \hfill \mbox{(0,75~pt)}
