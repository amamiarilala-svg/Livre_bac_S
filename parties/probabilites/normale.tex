...
$\mathscr{N}(1000\,;100)$.
\begin{enumerate}
	\item Préciser $m$ et $\sigma$. \hfill \mbox{(0,5~pt)}
	...
	paquet soit conforme. \hfill \mbox{(0,75~pt)}
...
\begin{enumerate}
	...
	\hfill \mbox{(1~pt)}
	\item Calculer la durée de vie moyenne de l'appareil. \hfill \mbox{(0,5~pt)}
	\item Calculer $\Prob(X\leqslant 2)$. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	qu'il fonctionne encore $4$ ans. \hfill \mbox{(0,75~pt)}
	\item Déterminer la durée $t$ telle que $\Prob(X\leqslant t)=0{,}5$
	(médiane). \hfill \mbox{(1~pt)}
	...
	appareil dépasse $4$ ans. \hfill \mbox{(1~pt)}
\end{enumerate}
...
$[2\,;10]$.
\begin{enumerate}
	\item Donner la densité de $X$ et calculer $\Esp(X)$. \hfill \mbox{(0,75~pt)}
	\item Calculer $\Prob(X\leqslant 5)$ et $\Prob(X\geqslant 8)$.
	\hfill \mbox{(0,75~pt)}
	\item Calculer $\Prob(4\leqslant X\leqslant 7)$. \hfill \mbox{(0,5~pt)}
	\item Sachant que le service a déjà duré $6$ minutes, calculer la
	probabilité qu'il dure au total moins de $8$ minutes. \hfill \mbox{(1~pt)}
...
\begin{enumerate}
	...
	($X\geqslant 14$). \hfill \mbox{(1~pt)}
	\item Calculer $\Prob(8\leqslant X\leqslant 14)$. \hfill \mbox{(0,75~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	minimale pour l'obtenir. \hfill \mbox{(1~pt)}
	\item On élimine les $5\,\%$ plus faibles. Déterminer la note en dessous
	de laquelle on est éliminé. \hfill \mbox{(1~pt)}
	\item Sur $400$ candidats, estimer le nombre de mentions. \hfill \mbox{(0,5~pt)}
\end{enumerate}
...
\begin{enumerate}
	...
	acceptable. \hfill \mbox{(1,25~pt)}
	\item Avec $\sigma = 0{,}8$ mm, calculer $\Prob(X<298)$ (on donne
	$\Phi(2{,}5)\approx 0{,}994$). \hfill \mbox{(1~pt)}
