...
\begin{vraievie}{Pourquoi une gousse de vanille sur cinq est classée « extra »}
	Madagascar assure environ $80\,\%$ de la production mondiale de
	vanille. Après séchage, chaque gousse est classée selon sa longueur :
	la catégorie la plus recherchée, « extra », exige une longueur d'au
	moins $16$ cm.

	Modélisons la longueur $L$ (en cm) d'une gousse par une loi normale
	$\mathscr{N}(m,\sigma^2)$ de moyenne $m=15$ et d'écart-type
	$\sigma=1{,}2$. La proportion de gousses classées « extra » est
	\[
	\Prob(L\geqslant 16) = \Prob\!\left(Z\geqslant\frac{16-15}{1{,}2}\right)
	= \Prob(Z\geqslant 0{,}83) \approx 0{,}202,
	\]
	soit environ \textbf{une gousse sur cinq}. Une gousse extra pouvant
	valoir $2$ à $3$ fois le prix d'une gousse standard, ce seul
	écart-type détermine une bonne partie de la valeur d'une récolte
	entière.

	\reserve{Moyenne et écart-type choisis pour l'illustration ; la
	longueur réelle d'une gousse dépend de la variété, du terroir et du
	savoir-faire de préparation.}
\end{vraievie}
