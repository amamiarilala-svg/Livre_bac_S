...
% ------------------------------------------------------------
\exercice{Problème de divisibilité combinée \hfill \etoilepleine\etoilepleine\etoilevide}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
\exercice{Équation diophantienne et théorème de Gauss \hfill \etoilevide\etoilevide\etoilepleine}
% ------------------------------------------------------------
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		$\mathrm{PPCM}(180\,;\,36)$, puis en déduire une valeur possible de $c$.
	\end{enumerate}
