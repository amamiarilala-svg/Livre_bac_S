...
\begin{enumerate}
	\item Donner tous les diviseurs positifs de $36$, puis $D(36) \cap D(24)$.
...
\begin{enumerate}
	\item À l'aide de la première congruence, écrire $n$ sous la forme $n = 3k + 2$ avec $k \in \Z$.
	\item Substituer dans la deuxième congruence et résoudre en $k$.
	\item Lister toutes les solutions dans $\{0, 1, \ldots, 50\}$.
\end{enumerate}
